...
#
#     > powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://github.com/Wittstock-ElkomPlan/win10script/raw/master/win10WithoutNumpad.ps1')"
#
...
Function DisableWin11Upgrade {
	...
	Set-ItemProperty -Path $keypath -Name "UpgradeAvailable" -Type DWord -Value 0 -Force
}
